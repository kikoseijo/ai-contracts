...
TODO: UpdateSpokeAgentConfigAction Importante para el Spoke: el PUT debe enviar siempre name, greeting, custom_instructions y vault_ids (ya no vale el “partial update” con solo sometimes). spoke_tools sigue siendo opcional.
